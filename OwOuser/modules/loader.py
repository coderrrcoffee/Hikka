...
class LoaderMod(loader.Module):
    ...
    strings = {
        ...
        "inline_init_failed": (
            "🚫 <b>This module requires OwO inline feature and "
        ...
        "version_incompatible": "🚫 <b>This module requires OwO {}+\nPlease, update with </b><code>.update</code>",
    ...
    async def load_module(
        ...
        if re.search(r"# ?scope: ?OwO_min", doc):
            ver = re.search(
                r"# ?scope: ?OwO_min ([0-9]+\.[0-9]+\.[0-9]+)",
                doc,
            ).group(1)
