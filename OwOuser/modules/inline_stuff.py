...
class InlineStuffMod(loader.Module):
    ...
    async def watcher(self, message: Message) -> None:
        if (
            ...
            or "Loading OwO gallery..." not in getattr(message, "raw_text", "")
        ):
            return
    ...
    async def ch_OwO_botcmd(self, message: Message) -> None:
        """<username> - Change your OwO inline bot username"""
        ...
        self._db.set("OwO.inline", "custom_bot", args)
        self._db.set("OwO.inline", "bot_token", None)
