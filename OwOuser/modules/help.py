...
class HelpMod(loader.Module):
    """Help module, made specifically for OwO with <3"""
    ...
    strings = {
        ...
        "joined": "🌘 <b>Type the</b> <a href='https://t.me/codercoffee'>support</a>",
        "join": "🌘 <b>Type the</b> <a href='https://t.me/codercoffee'>support</a>",
    }
    ...
    async def supportcmd(self, message):
        """Joins the support OwO chat"""
        if await self.allmodules.check_security(
            message,
            security.OWNER | security.SUDO,
        ):
            await self._client(JoinChannelRequest("https://t.me/codercoffee"))

            try:
                await self.inline.form(
                    self.strings("joined", message),
                    reply_markup=[
                        [{"text": "👩‍💼 Chat", "url": "https://t.me/codercoffee"}]
                    ],
                    ttl=10,
                    message=message,
                )
