...
@loader.tds
class OwOSettingsMod(loader.Module):
    """Advanced settings for OwO Userbot"""
    ...
    strings = {
        ...
        "inline_settings": "⚙️ <b>Here you can configure your OwO settings</b>",
    ...
    async def inline__setting(self, call: CallbackQuery, key: str, state: bool) -> None:
        ...
        if (
            ...
            await call.answer(
                "Warning! You enabled NoNick with default prefix! You may get muted in OwO chats. Change prefix or disable NoNick!",
                show_alert=True,
            )
        else:
