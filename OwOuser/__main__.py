...
def restart():
    if "OWO_DO_NOT_RESTART" in os.environ:
    ...
    os.environ["OWO_DO_NOT_RESTART"] = "1"
...
if sys.version_info < (3, 8, 0):
...
elif __package__ != "OwO":  # In case they did python __main__.py
    ...
    if __name__ == "__main__":
        if "OWO_DO_NOT_RESTART" in os.environ:
            del os.environ["OWO_DO_NOT_RESTART"]

        main.OwO.main()  # Execute main function
